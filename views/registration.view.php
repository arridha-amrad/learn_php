...
<main class="mx-auto max-w-lg py-10">
	...
	<form class="space-y-4" method="POST" action="/register">
		...
		<div class="flex flex-col gap-2">
			...
			<input value="<?= $_POST["name"] ?? "" ?>" id="name" class="rounded border border-slate-300 py-2 px-4" type="text" name="name">
		...
		<button type="submit" class="px-4 py-2 rounded bg-green-500 text-white">Register</button>
